...
const buttonVariants = cva(
	"inline-flex items-center justify-center rounded-md border text-sm font-medium transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-slate-100 dark:hover:bg-slate-800 dark:hover:text-slate-100 dark:data-[state=open]:bg-slate-800",
	{
		variants: {
			variant: {
				default:
					"bg-black text-white hover:bg-white hover:text-black dark:bg-slate-50 dark:text-slate-900",
				destructive:
			...
			size: {
				default: "min-h-9 py-2 px-4",
				sm: "min-h-9 rounded-md px-2",
